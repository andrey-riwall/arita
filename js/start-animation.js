const startAnimation = () => {
  ...
  const currentSlide = document.querySelector('.slide-bg__inner.is_current');
  const currentShape = document.querySelector('.shapes__item.is_current');
  const currentText = document.querySelector('.slides-container__slide.is_active');
